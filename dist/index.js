...
// src/lib/nacl/nacl.js
var require_nacl = __commonJS({
  "src/lib/nacl/nacl.js"(exports, module2) {
    (function(nacl2) {
      "use strict";
...
// src/wallet.ts
var import_nacl = __toModule(require_nacl());
  ...
  initEvents() {
    ...
    if (this.installed()) {
      ...
      this.handleAccountsChanged = (accounts) => {
        self2._handleAccountsChanged(accounts);
      };
      ...
      if (this.installed()) {
        if (eventPayload == null ? void 0 : eventPayload.userTriggeredConnect) {
          await this.provider.request({ method: "eth_requestAccounts" }).then((accounts) => {
            self2._handleAccountsChanged(accounts, eventPayload);
          });
        } else {
          if (this.provider.selectedAddress) {
            self2._handleAccountsChanged([this.provider.selectedAddress], eventPayload);
          }
        }
      }
    } catch (error) {
...
var MetaMaskProvider = class extends EthereumProvider {
  ...
  async encrypt(key) {
    ...
    const nonce = import_nacl.default.randomBytes(import_nacl.default.box.nonceLength);
    const ephemeralKeyPair = import_nacl.default.box.keyPair();
    const encKey = import_nacl.default.box(msg, nonce, publicKey, ephemeralKeyPair.secretKey);
  ...
  async connect(eventPayload) {
    ...
    try {
      ...
      if (hasAccounts) {
        ...
        this._selectedAddress = self2.toChecksumAddress(accountAddress);
        if (self2.wallet.web3) {
          self2.wallet.web3.selectedAddress = this._selectedAddress;
        }
        this.wallet.account = {
          address: accountAddress
        };
...
var _Wallet = class {
  ...
  send(to, amount) {
    ...
    let promise = new Promise(async function(resolve, reject) {
      ...
      try {
        ...
        let result;
        if (self2._account && self2._account.privateKey) {
  ...
  signMessage(msg) {
    ...
    let promise = new Promise(async function(resolve, reject) {
      try {
        ...
        } else if (typeof window !== "undefined" && self2.clientSideProvider) {
          result = await self2.clientSideProvider.provider.request({
  ...
  signTypedDataV4(data) {
    ...
    let promise = new Promise(async (resolve, reject) => {
      try {
        self2._web3.currentProvider.send({
          jsonrpc: "2.0",
          method: "eth_signTypedData_v4",
          params: [
            self2.defaultAccount,
            JSON.stringify(data)
          ],
          id: Date.now()
        }, function(err, result) {
