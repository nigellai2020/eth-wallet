...
function generateMerkleTree(wallet, leavesData, abi) {
    ...
    const merkleTree = new merkleTree_1.MerkleTree(wallet, leaves, abi);
    return merkleTree;
}
