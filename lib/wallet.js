...
exports.Wallet = exports.Web3ModalProvider = exports.MetaMaskProvider = exports.EthereumProvider = exports.DefaultNetworksMap = exports.stringToBytes = exports.stringToBytes32 = exports.toString = void 0;
...
class Wallet {
    ...
    async multiCall(calls, gasBuffer) {
        ...
        if (!contractAddress)
            return null;
        const multiCall = new contracts_1.MultiCall(this, contractAddress);
        const result = await multiCall.multicallWithGasLimitation.call({
            calls,
            gasBuffer: new bignumber_js_1.BigNumber(gasBuffer !== null && gasBuffer !== void 0 ? gasBuffer : '3000000')
        });
        return result;
    }
