...
(function (Wallet_1) {
    ...
    (function (WalletPlugin) {
        WalletPlugin[WalletPlugin["MetaMask"] = 0] = "MetaMask";
        WalletPlugin[WalletPlugin["Coin98"] = 1] = "Coin98";
        WalletPlugin[WalletPlugin["TrustWallet"] = 2] = "TrustWallet";
        WalletPlugin[WalletPlugin["BinanceChainWallet"] = 3] = "BinanceChainWallet";
        WalletPlugin[WalletPlugin["ONTOWallet"] = 4] = "ONTOWallet";
    })(WalletPlugin = Wallet_1.WalletPlugin || (Wallet_1.WalletPlugin = {}));
    Wallet_1.WalletPluginMap = {
    ...
    class ClientSideProvider {
        ...
        get installed() {
            return Wallet_1.WalletPluginMap[this.walletPlugin].installed();
        }
        get provider() {
            return Wallet_1.WalletPluginMap[this.walletPlugin].provider;
        }
        async init() {
            let self = this;
            if (this.installed) {
            ...
            return new Promise(async function (resolve, reject) {
                try {
                    ...
                    try {
                        ...
                        if (error.code === 4902) {
                            try {
                                let network = Wallet_1.Networks[chainId];
                                if (!network)
                                    resolve(false);
    ...
    class Wallet {
        ...
        static isInstalled(walletPlugin) {
            return Wallet_1.WalletPluginMap[walletPlugin].installed();
        }
