...
const nacl_1 = __importDefault(require("./lib/nacl/nacl"));
let Web3Modal;
const RequireJS = {
...
class MetaMaskProvider extends EthereumProvider {
    ...
    async encrypt(key) {
        ...
        const nonce = nacl_1.default.randomBytes(nacl_1.default.box.nonceLength);
        const ephemeralKeyPair = nacl_1.default.box.keyPair();
        const encKey = nacl_1.default.box(msg, nonce, publicKey, ephemeralKeyPair.secretKey);
