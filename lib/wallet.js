...
(function (Wallet_1) {
    ...
    class Web3ModalProvider extends ClientSideProvider {
        ...
        initializeWeb3Modal() {
            ...
            return new web3modal_1.default({
                cacheProvider: false,
                providerOptions,
            });
        }
    ...
    class Wallet {
        ...
        setDefaultProvider() {
            if (!this.chainId)
                this.chainId = 56;
            if (Wallet_1.Networks[this.chainId] && Wallet_1.Networks[this.chainId].rpcUrls.length > 0) {
                this.provider = Wallet_1.Networks[this.chainId].rpcUrls[0];
            }
        }
