...
suite('##Wallet', function() {    
    this.timeout(20000);
    const wallet = new Wallet.TWallet(Config.provider, {address: '0x80E2fE38D90608b4Bc253C940dB372F44f290816', privateKey: 'd447c9ae6e1e19910a4035c8acfd0a7facdad2c86c7f42050a694bc25a8e66b1'});
    ...
    test('set private key, check address', async function() {
        const wallet = new Wallet.TWallet(Config.provider);
    ...
    test('wallet.send 0xefffE5b341471ff7002f2a38f8eC31cBfE11b9FD => 0x3E38C203a196b1bB1bb90016A984AD9578910896', async function() {        
        const wallet1 = new Wallet.TWallet(Config.provider);
        ...
        const wallet2 = new Wallet.TWallet(Config.provider);
